...
class _homeScreenState extends State<homeScreen> {
  DogModel selectedIcon = DogModel(id: "id", profile: "profile", name: "name", dob: "dob", month: "month", breed: "breed", certificate: "certificate");
            ...
            children: [
              Expanded(
                ...
                child: Container(
                  ...
                  gradient: LinearGradient(colors: [Color.fromARGB(255, 69, 205, 232).withOpacity(0.5),Color.fromARGB(255, 212, 218, 222)]) ),
  ...
  Padding(
  padding:  EdgeInsets.only(right: size.width*0.08  , top: size.height*0.03),
  child: Container(
          ...
          children: [
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => Landing1()),
                );
              },
              child: Container(
               height: size.height*0.17,
